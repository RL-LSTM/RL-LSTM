...
def main(args):
	...
	critic = CriticNetwork(state_dim, action_dim, learning_rate = args.learning_rate, 
						  epsilon = args.epsilon, seed = args.seed, batch_size = args.batch_size,
						  tau = args.tau, duel_enable = True, duel_type = args.duel_type)
...
if __name__ == '__main__':
	...
	parser.add_argument('--epsilon', type=float, default=0.01, help='noise standard deviation')
	...
	parser.add_argument('--actor_weights', type=str, default='dueldqn_cartpole', help='Filename of critic weights. Default is ddqn_cartpole')
	parser.add_argument('--duel_type', type=str, default='avg', help='type of duel dqn')
