...
if __name__ == '__main__':
    ...
    parser.add_argument('--episode_len', type=int, default=500, help='episodic lengths')
    parser.add_argument('--episode_steps', type=int, default=500, help='steps per episode')
